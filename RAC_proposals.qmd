...
Note that the scope of this chapter is limited to the IM role in handling the RAC proposal submissions. Details on the RAC committee (appointments and responsibilities) are described in detail in the *Organization Plan for the Hubbard Brook Ecosystem Study* - a document managed and available from the HB Scientific Coordinating Commitee (SCC).
...
-   The new RAC chair in 2025 has monitored JotForm and handled proposal exports.
